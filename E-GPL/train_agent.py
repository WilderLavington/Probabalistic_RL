...
class TRAIN_AGENT(torch.nn.Module):
    ...
    def train_gym_task(self):
        ...
        for iter in range(iterations):
            ...
            state_total, action_total, reward_total = game.sample_game(env, policy, torch.ones(self.trajectory_length))
    ...
    def train_gym_task_adaptive(self, optim_probabilities_init, adaptive_step):
        ...
        for iter in range(self.iterations):
            ...
            start = time.time()
            # get new batch of trajectories from simulator
            state_total, action_total, reward_total = game.sample_game(env, policy, torch.ones(self.trajectories))
