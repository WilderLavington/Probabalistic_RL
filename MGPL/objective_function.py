...
class PHI_SLEEP(torch.nn.Module):
    ...
    """
        ...
        UNDER THE GENERATIVE MODEL AND TRAINS ON THEM. IN THE SLEEP UPDATE,
        I HAVE REMOVED THE REPLAY BUFFER, AS IT WOULD SEEM TO STORE POSSIBLY
        UNREASONABLE TRAJECTORIES GENERATED IN THE "DREAM STATE".
    """
